...
const int16_t relay_groups[VA_RELAY_GROUP_NBR_OF] =
{
    ...
    [VA_RELAY_GROUP_KORISTE]  = RELAY_GR_BIT_KORISTE,
};


relay_addr_st relay_addr[VA_RELAY_NBR_OF] =
{
    [VA_RELAY_UNDEF] =      {"XXX", "XXXXX", 0, 0x00000000},
    ...
    [VA_RELAY_MH1_3] =      {"MH1", "RMH13", 0, RELAY_GR_BIT_ALL },
    [VA_RELAY_MH1_4] =      {"MH1", "RMH14", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_MH1},
    [VA_RELAY_MH1_5] =      {"MH1", "RMH15", 0, RELAY_GR_BIT_ALL },
    [VA_RELAY_MH2_1] =      {"MH2", "RMH21", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_MH2},
    [VA_RELAY_MH2_2] =      {"MH2", "RMH22", 0, RELAY_GR_BIT_ALL },
    [VA_RELAY_KEITTIO_1] =  {"MH1", "RKOK1", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_ARRIVE | RELAY_GR_BIT_K},
    [VA_RELAY_KEITTIO_2] =  {"MH1", "RKOK2", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_ARRIVE | RELAY_GR_BIT_K},
    [VA_RELAY_KEITTIO_3] =  {"MH1", "RKOK3", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_ARRIVE | RELAY_GR_BIT_K},
    [VA_RELAY_KEITTIO_4] =  {"MH1", "RKOK4", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_ARRIVE | RELAY_GR_BIT_K},
    [VA_RELAY_KEITTIO_5] =  {"MH1", "RKOK5", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_ARRIVE},
    [VA_RELAY_KHH_1] =      {"TK1", "RKHH1", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_ARRIVE | RELAY_GR_BIT_KHH},
    [VA_RELAY_KHH_2] =      {"MH2", "RKHH2", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_KHH},
    [VA_RELAY_PSH] =        {"MH2", "RPSH_", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_KHH},
    [VA_RELAY_SAUNA] =      {"TK1", "RSAUN", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_KHH},
    [VA_RELAY_PARVI] =      {"TK1", "RPARV", 0, RELAY_GR_BIT_ALL },
    [VA_RELAY_PIHA] =       {"TK1", "RPIHA", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_ULKO},
    [VA_RELAY_TERASSI] =    {"TK1", "RTERA", 0, RELAY_GR_BIT_ALL },
    [VA_RELAY_POLKU] =      {"TK1", "RPOLK", 0, RELAY_GR_BIT_ALL },
    [VA_RELAY_JOULU] =      {"TK1", "RJOUL", 0, RELAY_GR_BIT_ALL | RELAY_GR_BIT_KORISTE},
};
...
void relay_send_one(va_relays_et rindx, char value)
{
    // <#X1N:RMH1;RKOK1;T;->\n  
    // {"Z":"MH1","S":"RKOK1","V":"T","R":"-"}
    Serial.printf("#%d: %s %s %c\n", rindx, relay_addr[rindx].unit,relay_addr[rindx].relay, value);
